...
*RicePDF* is a custom deployment of the
...
In Firefox, *RicePDF* replaces the built-in PDF.js viewer as the default PDF
...
**Note:** In Firefox, *RicePDF* uses Manifest Version 2, while in Chromiums it
uses MV3.
...
---
Credits: https://github.com/shivaprsd/doqment/ 